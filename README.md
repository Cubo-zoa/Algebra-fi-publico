# Algebra-fi-publico
Notas:  
Al usar la forma binómica, no usar espacios entra numeros: 4+4i ✓ 4 + 4i X  
Al usar la forma exponencial, usar el operador "*" entre un numero y pi.: e^3*pi/2 ✓ e^3pi/2 X  
